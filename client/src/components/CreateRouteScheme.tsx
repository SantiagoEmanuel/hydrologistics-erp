...
interface TierLocal {
  id: string; // ID temporal para el renderizado local
  productId: number | "";
  minVolume: number | "";
  maxVolume: number | ""; // Vacio significa infinito
  renderPrice: number | "";
}
          ...
          <div className="flex flex-col gap-6 sm:flex-row">
            ...
            <div className="flex items-center gap-3 pt-6">
              <label className="relative inline-flex cursor-pointer items-center">
                ...
                />
                <div className="peer h-7 w-14 rounded-full bg-gray-200 peer-checked:bg-green-500 peer-focus:ring-4 peer-focus:ring-green-300 peer-focus:outline-none after:absolute after:top-[2px] after:left-[2px] after:h-6 after:w-6 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
                  ...
                  {tiers.map((tier) => (
                    ...
                    >
                      ...
                      <div className="relative col-span-1 md:col-span-3">
                        ...
                        <span className="absolute top-[34px] left-3 -translate-y-1/2 font-bold text-gray-500 md:top-1/2">
                          $
                        </span>
                        <input
                          type="number"
