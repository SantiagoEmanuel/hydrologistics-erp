...
export default function AdminDashboard() {
  ...
  const [data, setData] = useState<any>({
    kpi: {
      ...
      salesCount: { value: 0, trend: 0, isPositive: true },
    ...
    <div className="flex flex-col gap-6 bg-gray-50 p-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <QuickActionCard
          ...
          desc="Exportar y revisar ventas"
          color="bg-green-50 hover:bg-green-100"
        />
        <QuickActionCard
          to="/dashboard/admin/dashboard/new-routes"
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={data.kpi.salesCount.value}
          trend={`${data.kpi.salesCount.trend.toFixed(1)}%`}
          isPositive={data.kpi.salesCount.isPositive}
          icon={<BoxesIcon />}
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex max-h-110 flex-col overflow-y-auto rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
