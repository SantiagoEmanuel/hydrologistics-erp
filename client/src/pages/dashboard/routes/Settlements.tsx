...
export default function Settlements() {
  ...
  const [lastSettlement, setLastSettlement] = useState<SettlementData | null>(
    null,
  );
  ...
  const handleAddBreakdownItem = () => {
    if (!newItemProduct || !newItemQty) return toast.error("Faltan datos");
    if (
      (newItemType === "BOLETA" || newItemType === "TRANSFER") &&
      !newItemClient
    )
          ...
          <div className="md:col-span-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  setDriverName(e.target.value.toLocaleLowerCase())
                }
              />
            </div>
          </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 grid grid-cols-1 gap-8 duration-500 xl:grid-cols-3">
          <div className="space-y-6 xl:col-span-2">
              ...
              <div className="flex items-center justify-between bg-gray-900 p-6 text-white">
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    ...
                    {DateTime.fromISO(preview.date).toLocaleString(
                      DateTime.DATE_MED,
                    )}
                  </p>
                </div>
                <div className="text-right">
                  ...
                  {isRecalculating ? (
                    <p className="animate-pulse text-4xl font-black text-gray-500 max-md:text-3xl">
                      Calculando...
                    </p>
                  ) : (
                    <p className="text-4xl font-black text-green-400 max-md:text-3xl">
                ...
                <table className="w-full text-left text-sm">
                  <thead className="border-b border-gray-100 bg-gray-50 text-gray-500">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-center font-semibold text-orange-600">
                        Deduc.
                      </th>
                      ...
                      <th className="px-4 py-3 text-right font-semibold text-purple-600">
                        Comp.
                      </th>
                    ...
                    {preview.summary.map((item, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="bg-orange-50/30 px-4 py-4 text-center font-bold text-orange-600">
                            {totalDeductions > 0 ? `-${totalDeductions}` : "-"}
                          </td>
                          <td className="bg-gray-50 px-4 py-4 text-center font-bold text-gray-900">
                            {item.cashUnits}
                          </td>
                          ...
                          <td className="px-4 py-4 text-right font-medium text-purple-600">
            ...
            <div className="flex gap-4">
              ...
              >
                <CheckCircle2 className="size-6 max-md:size-5" /> CONFIRMAR Y
                CERRAR
              </button>
            </div>
          </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-3 gap-2">
                  <button
                    onClick={() => setNewItemType("BOLETA")}
                    className={`rounded-lg border p-2 text-xs font-bold transition-all ${newItemType === "BOLETA" ? "border-blue-200 bg-blue-50 text-blue-700" : "border-gray-200 text-gray-500"}`}
                  >
                    BOLETA
                  </button>
                  <button
                    onClick={() => setNewItemType("TRANSFER")}
                    className={`rounded-lg border p-2 text-xs font-bold transition-all ${newItemType === "TRANSFER" ? "border-purple-200 bg-purple-50 text-purple-700" : "border-gray-200 text-gray-500"}`}
                  >
                    TRANSF.
                  </button>
                  <button
                    onClick={() => setNewItemType("EXCHANGE")}
                    className={`rounded-lg border p-2 text-xs font-bold transition-all ${newItemType === "EXCHANGE" ? "border-orange-200 bg-orange-50 text-orange-700" : "border-gray-200 text-gray-500"}`}
                  >
                    CAMBIO
                  </button>
                </div>
                          ...
                          {!isCreatingClient ? (
                            <>
                              ...
                              <button
                                ...
                                className="rounded-lg border border-gray-200 bg-gray-50 p-2 text-green-600 hover:border-green-300 hover:bg-green-50"
                                title="Nuevo Cliente"
                              >
                            ...
                            <div className="flex flex-1 flex-col gap-2 rounded-lg border border-gray-200 bg-gray-50 p-2">
                              ...
                              <button
                                ...
                                className="mt-1 flex w-full items-center justify-center gap-1 rounded bg-green-500 py-1.5 text-xs font-bold text-white hover:bg-green-600"
                              >
                            ...
                            <ul className="absolute z-20 mt-1 max-h-48 w-full overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-xl">
                              {filteredClients.map((c) => (
                                <li
                                  ...
                                  className="cursor-pointer border-b border-gray-50 px-3 py-2 text-sm hover:bg-blue-50"
                                >
                ...
                >
                  <header className="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-5 py-3">
                    ...
                    <div className="flex items-center gap-1 text-xs font-medium text-gray-500">
                      ...
                      {DateTime.fromISO(route.closedAt)
          ...
          <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
            <div className="bg-green-50 p-6 text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Verifica que tienes el dinero físico en mano.
              </p>
            </div>
            <div className="space-y-6 p-6">
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 text-center">
                <p className="text-xs font-bold text-gray-400 uppercase">
                  Total de efectivo a recibir
                </p>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-xl border border-gray-300 py-3 font-bold text-gray-600 hover:bg-gray-100"
                >
                  Revisar
                </button>
                <button
                  ...
                  disabled={loading}
                  className="flex-1 rounded-xl bg-green-600 py-3 font-bold text-white shadow-lg hover:bg-green-700"
                >
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-2xl">
            ...
            <div className="flex flex-col gap-3">
              <PDFDownloadLink
                ...
                fileName={`Rendicion_${lastSettlement.driverName}.pdf`}
              ...
              >
                {({ loading }) =>
                  loading ? (
                    ...
                    <>
                      <FileText className="h-5 w-5" /> Descargar Comprobante
                    </>
                  )
                }
              </PDFDownloadLink>
              <button
                ...
                className="w-full rounded-xl py-3 font-medium text-gray-400 hover:bg-gray-50 hover:text-gray-600"
              >
                Cerrar Ventana
              </button>
            </div>
